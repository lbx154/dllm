...
| run17   | `d532545`         | **重平衡奖励权重**：`[0.25 0.25 0 0.25 5.0]` → `[1.0 1.0 0 1.0 2.0]`。全对 rollout 权重从 10.0 → 4.0，format 三条合计 0.375 → 1.5，比例从 27:1 降到 2.7:1，让格式信号不再被 correctness 淹没 |   跑中 |         — |           — |         — |         — |      — | —                                                |

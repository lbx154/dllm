#!/usr/bin/env bash
# =============================================================================
# BT-GRPO run22 — full 4-layer Canary design (L1 oracle + L2 replay + L3+L4 theory)
#
# Postmortem of run21:
...
accelerate launch \
  ...
  examples/rl/grpo/llada/train_btgrpo.py \
    ...
    --dataset gsm8k \
    --output_dir .models/llada-btgrpo-run22 \
